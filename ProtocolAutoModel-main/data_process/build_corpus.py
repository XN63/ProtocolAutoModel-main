...
# other（其他）
#目前的主题分配规则：一个句子只能被分配到一个类别，如果一个句子同时符合多个类别的标准，
#则按优先级顺序分配：terminology > streams > state_machine > flow_control > frames > other
###句子标注属于多个类别，然后在不同任务拼包时再进行选择。
...
def main():
    ...
    outdir = "d:/ProtocolAutoModel-main/data/rfc9000_corpus"          
